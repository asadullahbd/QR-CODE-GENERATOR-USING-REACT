                ...
                <div className="row py-5">
                    <div className="col-md-6 offset-md-3">
                        ...
                        />
                        {
                          input && (
                            <>
                            <QRCodeCanvas value={input} size={200} level='M' className="mt-4 mb-3"/>
                            <button className="btn mt-1 d-block btn-warning fw-bold" onClick={downloadImage}>Download QR</button>
                            </>
                          )
                        }
                    </div>
